...
public class ProjetoServico {
	...
	@SuppressWarnings("unchecked")
	public List<Projeto> listarProjetoPorStatusETipo(StatusProjeto statusProjeto, TipoProjeto tipoProjeto) {

		try {

			Query query = this.entityManager.createQuery("FROM Projeto p WHERE p.statusProjeto =:param1 AND p.tipoProjeto =:param2");
			query.setParameter("param1", statusProjeto);
			query.setParameter("param2", tipoProjeto);
			return query.getResultList();
	...
	@SuppressWarnings("unchecked")
	public List<Projeto> listarProjetosPorImpactoETipo(Boolean impacto, TipoProjeto tipoProjeto) {

		try {

			Query query = this.entityManager.createQuery("FROM Projeto p WHERE p.tipoProjeto =:param1 AND p.impactaCo =:param2");
			query.setParameter("param1", tipoProjeto);
			query.setParameter("param2", impacto);
			return query.getResultList();			
